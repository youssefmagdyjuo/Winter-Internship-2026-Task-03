        ...
        <footer className="site-footer">
                ...
                <div className="footer-subscribe">
                    ...
                    <div className="social" aria-hidden="false">
                        ...
                        <a href="#" className="social-link" aria-label="Instagram">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5zm5 6.4A4.6 4.6 0 1016.6 13 4.6 4.6 0 0012 8.4zm6.5-2.6a1.1 1.1 0 11-1.1-1.1 1.1 1.1 0 011.1 1.1zM12 10.8A1.2 1.2 0 1110.8 9.6 1.2 1.2 0 0112 10.8z" /></svg>
                        </a>
                        <a href="#" className="social-link" aria-label="Facebook">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M22 12a10 10 0 10-11.6 9.88v-7h-2.2V12h2.2V9.6c0-2.18 1.3-3.4 3.28-3.4.95 0 1.95.17 1.95.17v2.15h-1.1c-1.08 0-1.42.67-1.42 1.36V12h2.42l-.39 2.88h-2.03v7A10 10 0 0022 12z" /></svg>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div className="footer-bottom">
                <div className="container footer-bottom-inner">
                    <small>© {new Date().getFullYear()} Viteruca. All rights reserved.</small>
                </div>
            </div>
        </footer>
    )
